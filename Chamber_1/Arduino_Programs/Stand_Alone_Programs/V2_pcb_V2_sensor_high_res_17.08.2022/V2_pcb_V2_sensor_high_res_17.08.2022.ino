 ...
 *
 *17.08.2022 edit: changed servo values to fit the new servo arm. Added 2x differential methane measurements on sensor board v2. Reduced memory requirements by writing directly to sd card and removing function instead placing it in the main skatch. 
 *edited fan to be 5mins in new setup. edited sensors to measure continuousy instead of in sets of 5. 
...
//strain sensor 
#include "HX711.h"
#define calibration_factor -720  //-1000 = load cell in chamber b1. chamber a1 is -720, chamber c1 = 2238 , chamber D1 = 1918, chamber E1 = 6918
...
//ch4_differential_3 = ads.readADC_Differential_0_1();
//delay(1000);
//ch4_mv_3 = (ch4_differential_3 * multiplier);
/*
//delay(1000);
