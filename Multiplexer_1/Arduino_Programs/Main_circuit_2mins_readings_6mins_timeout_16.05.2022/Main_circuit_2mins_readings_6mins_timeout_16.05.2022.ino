...
//for(;;){ //the former for loop 
 ...
 unsigned long end_time = (start_time + 360000); //was 180000 which is 3 mins. Extend this to 6 mins based on final reading of 14-15.05.2022 test? = 
...
//for(;;){ //the former for loop 
 ...
 unsigned long start_time = millis();
 unsigned long end_time = (start_time + 360000); // was 180000 3 mins, changed to 6 mins 360000
 unsigned long current_time = millis();
